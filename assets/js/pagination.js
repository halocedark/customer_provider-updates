...
SmoothPagination = function(parent, dataTarget, object)
{
	...
	this.resultsData = [];
	this.resultsPerPage = (object.resultsPerPage == null) ? 15 : object.resultsPerPage;
	this.totalResults = this.data.length;
	this.pageLinksCount = (object.linksCount == null) ? 0 : object.linksCount;
	this.parent = parent;
	var page = 0;
	...
	links += '<li class="spnm-list-item"><a href="#" class="spnmli-nav-link" data-role="PAGE_LINK_FIRST">Première</a></li>';
	links += '<li class="spnm-list-item"><a href="#" class="spnmli-nav-link" data-role="PAGE_LINK_PREVIOUS">Précédente</a></li>';
	...
	links += '<li class="spnm-list-item"><a href="#" class="spnmli-nav-link" data-role="PAGE_LINK_NEXT">Suivante</a></li>';
	links += '<li class="spnm-list-item"><a href="#" class="spnmli-nav-link" data-role="PAGE_LINK_LAST">Dernière</a></li>';
	links += '</ul>';
