...
SmoothPagination = function(parent, dataTarget, object)
{
	...
	links += '<li class="spnm-list-item"><a href="#" class="spnmli-nav-link" data-role="PAGE_LINK_FIRST">الأول</a></li>';
	links += '<li class="spnm-list-item"><a href="#" class="spnmli-nav-link" data-role="PAGE_LINK_PREVIOUS">السابق</a></li>';
	...
	links += '<li class="spnm-list-item"><a href="#" class="spnmli-nav-link" data-role="PAGE_LINK_NEXT">التالي</a></li>';
	links += '<li class="spnm-list-item"><a href="#" class="spnmli-nav-link" data-role="PAGE_LINK_LAST">الاخير</a></li>';
	links += '</ul>';
